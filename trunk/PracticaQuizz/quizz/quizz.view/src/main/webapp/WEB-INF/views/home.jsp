...
<script src="resources/js/jquery.mobile-detect.min.js"
		...
		<div id="menu">
			<sec:authorize ifAnyGranted="ROLE_ADMIN">
				<a href="javascript:void"
					onclick="javascript:generic.getList('usuario');"
					title="Ver usuarios">Usuarios</a>
				<a href="javascript:void"
					onclick="javascript:generic.getList('encuesta');"
					title="Ver encuestas">Encuestas</a>
			</sec:authorize>
			<a href="javascript:void"
				onclick="javascript:generic.getList('rellenarEncuesta');"
				title="Rellenar encuestas">Rellenar encuesta</a>

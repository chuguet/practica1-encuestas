...
privileged aspect UsuarioIntegrationTest_Roo_IntegrationTest {
    ...
    public void UsuarioIntegrationTest.testFindUsuario() {
        ...
        Assert.assertEquals("Find method for 'Usuario' returned the incorrect identifier", id, obj.getId_());
    }
    ...
    public void UsuarioIntegrationTest.testPersist() {
        ...
        Assert.assertNull("Expected 'Usuario' identifier to be null", obj.getId_());
        obj.persist();
        obj.flush();
        Assert.assertNotNull("Expected 'Usuario' identifier to no longer be null", obj.getId_());
    }
